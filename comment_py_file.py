...
class commentateur:
    def __init__(self, path_to_watch: str = "./Push_code_here", path_to_save: str = "./Modified", path_to_copy: str = "./Original", watchdog: bool = False):
        """
    ...
    def watch_push_code_here(self, delay_time: int = 2):
        """
        ...
        while True:
            ...
            for item in os.listdir(self.push_code_here_path):
                item_path = os.path.join(self.push_code_here_path, item)
                ...
                # Si l'élément est un dossier, parcourez-le récursivement
                    ...
                    # a modifier
                    self.watch_push_code_here(item_path)
